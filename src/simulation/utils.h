...
namespace CommonUtils
{
	 ...
	 */
	template <typename T, typename A>
	inline bool isVecElemsUnique(const vector<T, A>& vec)
	{
	 ...
	 * \return
	 */
	inline bool isBoolVecAllTrue(const vector<bool>& vec)
	{
	 ...
	 */
	template <typename T, typename A>
	inline int findIndexByElem(const vector<T, A>& vec, const T member)
	{
	...
	template <typename T, typename A>
	inline T vecMinElem(const vector<T, A>& vec)
	{
	...
	template <typename T, typename A>
	inline T vecMaxElem(const vector<T, A>& vec)
	{
	...
	template <typename T, typename A>
	inline T vecElemsSum(const vector<T, A>& vec)
	{
		T sum_res = 0;
